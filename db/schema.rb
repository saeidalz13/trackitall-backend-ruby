...
ActiveRecord::Schema[7.2].define(version: 20_241_123_030_042) do
  ...
  create_table 'interview_questions', force: :cascade do |t|
    ...
    t.index %w[user_id job_id question], name: 'index_interview_questions_on_user_id_and_job_id_and_question',
                                         unique: true
  end
  ...
  create_table 'jobs', id: { type: :string, limit: 26 }, force: :cascade do |t|
    ...
    t.string 'description', limit: 15_000
    t.string 'ai_insight', limit: 10_000
  ...
  create_table 'leetcode_attempts', force: :cascade do |t|
    ...
    t.check_constraint "language::text = ANY (ARRAY['c'::character varying, 'c#'::character varying, 'c++'::character varying, 'dart'::character varying, 'elixir'::character varying, 'erlang'::character varying, 'go'::character varying, 'java'::character varying, 'javascript'::character varying, 'kotlin'::character varying, 'php'::character varying, 'python'::character varying, 'racket'::character varying, 'ruby'::character varying, 'rust'::character varying, 'scala'::character varying, 'swift'::character varying, 'typescript'::character varying]::text[])",
                       name: 'language_check'
  end
  ...
  create_table 'technical_challenges', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id job_id question], name: 'index_technical_challenges_on_user_id_and_job_id_and_question',
                                         unique: true
